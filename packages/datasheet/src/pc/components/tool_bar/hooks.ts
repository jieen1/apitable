...
export const ToolbarMap = {
  ...
  [ToolBarMenuCardOpenState.ConditionalFormat]: ToolHandleType.ConditionalFormat,
...
export const ToolbarReMap = {
  ...
  [ToolHandleType.OrgChartSetting]: ToolBarMenuCardOpenState.OrgChartSetting,
  [ToolHandleType.ConditionalFormat]: ToolBarMenuCardOpenState.ConditionalFormat,
