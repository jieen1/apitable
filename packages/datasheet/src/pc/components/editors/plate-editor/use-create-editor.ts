...
import { WikiLinkElement } from '@/components/plate-ui/wikilink-element';
import { WikiLinkInputPlugin, WikiLinkPlugin } from '@/components/editor/plugins/wikilink-plugin';
import { WikiLinkInputElement } from '../plate-ui/wikilink-input-element';
import { FindReplacePlugin } from '@udecode/plate-find-replace';
import { SearchHighlightLeaf } from '../plate-ui/search-highlight-leaf';
import { FindReplaceToolbarPlugin } from './plugins/find-replace-toolbar-plugin';
...
export const viewComponents = {
  ...
  [WikiLinkPlugin.key]: WikiLinkElement,
...
export const editorComponents = {
  ...
  [WikiLinkInputPlugin.key]: WikiLinkInputElement,
};
